...
/**
 * VerticalFlowLayout is similar to FlowLayout except it lays out client.app.components
 ...
 * the VerticalFlowLayout manager to resize all client.app.components to expand to the
...
public class VerticalFlowLayout extends FlowLayout {
    ...
    /**
     * Returns the preferred dimensions given the client.app.components
    ...
    /**
     * places the client.app.components defined by first to last within the target
